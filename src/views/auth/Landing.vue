				...
				<v-row align="center">
					<v-col cols="12" class="text-center">
						<div class="text-center">
							<h2 class="text-h5">The best way to start developing</h2>
							...
							<v-row align="center">
								<v-col cols="12" md="4">
									<v-card class="elevation-0 transparent">
										...
										<v-card-title primary-title class="layout justify-center">
											<div class="text-h5 text-center">Material Design</div>
										</v-card-title>
										<v-card-text>
											{{ lorem }}
										</v-card-text>
								...
								<v-col cols="12" md="4">
									<v-card class="elevation-0 transparent">
										...
										<v-card-title primary-title class="layout justify-center">
											<div class="text-h5">Fast development</div>
										</v-card-title>
										<v-card-text>
											{{ lorem }}
										</v-card-text>
								...
								<v-col cols="12" md="4">
									<v-card class="elevation-0 transparent">
										...
										<v-card-title primary-title class="layout justify-center">
											<div class="text-h5 text-center">Completely Open Sourced</div>
										</v-card-title>
										<v-card-text>
											{{ lorem }}
										</v-card-text>
